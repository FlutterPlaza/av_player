...
class AvPlayerWindows extends AvPlayerPlatform {
  ...
  @visibleForTesting
  final methodChannel =
      const MethodChannel('com.flutterplaza.av_player_windows');
  ...
  Future<void> enterPip(int playerId, {double? aspectRatio}) async {
    // No-op on Windows. Use in-app PIP overlay instead.
  }
  ...
  Stream<AVPlayerEvent> playerEvents(int playerId) {
    return EventChannel(
      'com.flutterplaza.av_player_windows/events/$playerId',
    )
