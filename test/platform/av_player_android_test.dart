import 'package:av_player/src/platform/av_player_android.dart';
...
void main() {
  ...
  group('AvPlayerAndroid', () {
    ...
    test('registerWith() sets platform instance', () {
      ...
      expect(AvPlayerPlatform.instance, isA<AvPlayerAndroid>());
    });
    ...
    test('enterPip() sends request', () async {
      await platform.enterPip(1);
      expect(mock.log, ['enterPip']);
    });

    test('enterPip() sends request with aspect ratio', () async {
