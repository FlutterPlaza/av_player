import 'package:av_player/src/platform/av_player_macos.dart';
...
void main() {
  ...
  group('AvPlayerMacOS', () {
    late AvPlayerMacOS platform;
    late MockAvPlayerHostApi mock;

    setUp(() {
      platform = AvPlayerMacOS();
    ...
    test('registerWith() sets platform instance', () {
      AvPlayerMacOS.registerWith();
      expect(AvPlayerPlatform.instance, isA<AvPlayerMacOS>());
    });
