import 'package:av_player_android/av_player_android.dart';
...
void main() {
  ...
  group('AvPlayerAndroid', () {
    late AvPlayerAndroid platform;
    final log = <MethodCall>[];

    setUp(() {
      platform = AvPlayerAndroid();
    ...
    test('uses correct method channel name', () {
      expect(
        ...
        'com.flutterplaza.av_player_android',
      );
    });
    ...
    test('playerEvents() returns stream from correct event channel', () {
      // We can only verify the stream is created without error.
      // Actual event mapping is tested in the platform_interface types_test.
